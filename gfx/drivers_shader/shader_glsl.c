...
static unsigned gl_glsl_wrap_type_to_enum(enum gfx_wrap_type type)
{
   switch (type)
   {
...
static void gl_glsl_load_texture_data(
      GLuint id,
      ...
      const void *frame, unsigned base_size)
{
   ...
   GLenum wrap      = gl_glsl_wrap_type_to_enum(wrap_type);
